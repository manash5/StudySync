    ...
    <div className="min-h-screen mesh-bg flex items-center justify-center p-6">
      <div className="w-full max-w-md animate-fade-in-up">
        ...
        <div className="glass-card rounded-3xl p-8">
          <h1 className="font-display text-3xl font-bold mb-1 text-center" style={{ fontFamily: 'Sora, sans-serif' }}>
            Create your account
          </h1>
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <User size={16} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-blue-400 pointer-events-none" />
                <input
                  type="text"
                  value={name}
                  onChange={e => setName(e.target.value)}
                  placeholder="Prashant Tamang"
          ...
          <div className="relative my-5">
            ...
            <span className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 px-3 text-xs"
                  style={{ background: 'var(--bg-card)', color: 'var(--text-muted)' }}>or</span>
          </div>

            <button type="button" className="w-full py-3 rounded-xl text-sm font-medium transition-all flex items-center justify-center gap-2"
                  style={{ border: '1px solid var(--border)', color: 'var(--text-secondary)', background: 'rgba(59,130,246,0.04)' }}
              onClick={() => setError('Google signup is not configured on backend yet.')}>
